...
INSERT INTO "new_Event" ("carType", "category", "createdAt", "date", "id", "imageUrl", "location", "title", "updatedAt") SELECT "carType", "category", "createdAt", "date", "id", "imageUrl", "location", "title", "updatedAt" FROM "Event";
DROP TABLE "Event";
